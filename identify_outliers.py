...
try:
    ...
    if not df_filtered.empty:
        ...
        # Sort by Performance Score for easier review
        df_sorted = df_filtered.sort_values(by='Performance Score', ascending=False)

        print("\n--- All Filtered Races (Sorted by Performance Score) ---")
        print(df_sorted[existing_display_cols].to_string())
